<template>
    <div class="alarm-wrapper">
        ...
        <!-- 新建 -->
        <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="isCreateShow" width="37.78%"
                   custom-class="create-wrapper" @close="handClose">
            <ul>
                <li>
                    <span>挂牌编号</span>
                    <input type="text" v-model.trim="createObj.listing_number" placeholder="请输入内容">
                </li>
                <li>
                    <span>SN码</span>
                    <input type="text" v-model.trim="createObj.sn" placeholder="请输入内容">
                </li>
                <li>
                    <span>设备状态</span>
                    <el-select popper-class="select" v-model="createObj.status">
                        <el-option
                ...
                <li>
                    <span>省份</span>
                    <el-select popper-class="select" v-model="createObj.province">
                        <el-option
                                v-for="item in arr"
                                :key="item.name"
                                :label="item.name"
                ...
                <li>
                    <span>城市</span>
                    <el-select popper-class="select" v-model="createObj.city">
                        <el-option
                ...
                <li>
                    <span>区域</span>
                    <el-select popper-class="select" v-model="createObj.area">
                        <el-option
                                v-for="item in cityArr"
                                :key="item.name"
                                :label="item.name"
                ...
                <li>
                    <span>详细地址</span>
                    <input type="text" v-model.trim="createObj.address" placeholder="请输入内容">
                </li>
                <li>
                    <span>经度</span>
                    <input type="text" v-model.trim="createObj.longitude" placeholder="请输入内容">
                </li>
                <li>
                    <span>维度</span>
                    <input type="text" v-model.trim="createObj.latitude" placeholder="请输入内容">
                </li>
        ...
        <!-- 报警参数设置 -->
        <el-dialog title="报警参数修改" :visible.sync="isModifyParamShow" width="33%" custom-class="params-wrapper"
                   @close="handCloseParam">
            <ul>
                <li class="two">
                    <span>电压参数</span>
                    <div class="right">
